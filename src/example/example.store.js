...
var ExampleStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = "\n                SELECT *\n                FROM logs.log\n            ";
                        return [4 /*yield*/, dbConfig_1.client.query(query)];
                    case 1:
                        result = _a.sent();
    ...
    ExampleStore.prototype.getExampleById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var query, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
